                            ...
                            <div className="col-xl-6 col-lg-6 col-12">
                                <div className="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="300" className="slide-sub-title">
                                        <h5>Web Developer & Hacker</h5>
                                    </div>
                                    <div data-swiper-parallax="400" className="slide-text">
                                        <p>One must understand how misconceptions about pleasure and pain drive human behavior, just as bugs and vulnerabilities shape the flow of a system, and seek the truth behind them.</p>
                                    </div>
            ...
            <div className="static-hero-right">
                <div className="static-hero-img">
                    <div className="static-hero-img-inner">
                        ...
                        <div className="icon-2 floating-item"><img src='images/icon/kaliLinux.svg' alt="" /></div>
                        <div className="icon-3 floating-item"><img src='images/icon/js.svg' alt="" /></div>
