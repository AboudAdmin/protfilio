                    ...
                    <div className="col-lg-6 offset-lg-1 col-md-12 col-sm-12">
                        <div className="wpo-about-content">
                            <div className="wpo-about-title">
                                <h2>My Advantage</h2>
                                <p>I combine deep technical knowledge with creative problem-solving, delivering secure, high-performance web solutions while uncovering hidden vulnerabilities.</p>
                            </div>
                            <div className="wpo-about-funfact">
                                ...
                                <div className="grid">
                                    <div className="grid-inner">
                                        <h3><span data-count="43">97</span>%</h3>
                                        <p>ReactJs</p>
                                    </div>
                                </div>
                                <div className="grid">
                                    <div className="grid-inner">
                                        <h3><span data-count="37">67</span>%</h3>
                                        <p>python</p>
                                    </div>
                                </div>
                            </div>
